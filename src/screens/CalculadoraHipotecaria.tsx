...
export const CalculadoraHipotecaria = () => {
  ...
  // En el futuro, 'precioPropiedad' vendrá de la base de datos (IA analysis)
  ...
  const [tasaAnual, setTasaAnual] = useState(10.5); // Tasa promedio en México

  const [pagoMensual, setPagoMensual] = useState(0);

  // Lógica financiera del crédito
  useEffect(() => {
      ...
      <main className="p-4 space-y-6 max-w-md mx-auto w-full pb-10">
        ...
        <div className="bg-[#00213b] rounded-[2.5rem] p-8 text-white shadow-xl relative overflow-hidden">
          ...
          <div className="mt-6 pt-6 border-t border-white/10 grid grid-cols-2 gap-4">
            <div>
              <p className="text-[9px] uppercase opacity-50 font-bold">Monto del Crédito</p>
              <p className="font-bold text-sm">{formatearMoneda(precio * (1 - enganchePorcentaje / 100))}</p>
            </div>
            <div>
              <p className="text-[9px] uppercase opacity-50 font-bold">Enganche ({enganchePorcentaje}%)</p>
        ...
        <div className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100 space-y-8">
          ...
          {/* Precio (Info dinámica) */}
          <div className="space-y-3">
            <div className="flex justify-between items-center">
              <label className="text-[10px] font-black text-[#00213b] uppercase tracking-widest">Valor de la Propiedad</label>
          ...
          <div className="space-y-3">
            <div className="flex justify-between items-center">
              <label className="text-[10px] font-black text-[#00213b] uppercase tracking-widest">Enganche Inicial</label>
          ...
          {/* Plazo */}
          <div className="space-y-3">
            <label className="text-[10px] font-black text-[#00213b] uppercase tracking-widest block">Plazo del Crédito (Años)</label>
        ...
        <div className="px-4 flex gap-3 items-start">
          ...
          <p className="text-[10px] text-gray-400 leading-relaxed italic">
            *Este cálculo es informativo y puede variar según la institución bancaria y el perfil crediticio del cliente. Basado en tasa del {tasaAnual}%.
          </p>
        </div>
